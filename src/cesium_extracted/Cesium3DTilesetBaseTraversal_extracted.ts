 ...
 * 
 * Extracted from Cesium Engine (@cesium/engine/Source/Scene/Cesium3DTilesetBaseTraversal.js)
...
const ManagedArray = (Cesium as any).ManagedArray;
 ...
 */
Cesium3DTilesetBaseTraversal.selectTiles = function (tileset: any, frameState: any): void {
 ...
 * @param {any} frameState
 */
function selectDesiredTile(tile: any, frameState: any): void {
 ...
 * @returns {boolean}
 */
function updateAndPushChildren(tile: any, stack: any, frameState: any): boolean {
 ...
 * @param {any} frameState
 */
function executeTraversal(root: any, frameState: any): void {
  const { tileset } = root;
 ...
 * @returns {boolean}
 */
function executeEmptyTraversal(root: any, frameState: any): boolean {
