...
// Access all other modules through Cesium namespace (same pattern as working version)
const ApproximateTerrainHeights = Cesium.ApproximateTerrainHeights;
...
const Cesium3DTilesetMetadata = Cesium.Cesium3DTilesetMetadata;
const Cesium3DTileOptimizations = Cesium.Cesium3DTileOptimizations;
const Cesium3DTilePass = Cesium.Cesium3DTilePass;
const Cesium3DTileRefine = Cesium.Cesium3DTileRefine;
const Cesium3DTilesetCache = Cesium.Cesium3DTilesetCache;
const Cesium3DTilesetHeatmap = Cesium.Cesium3DTilesetHeatmap;
const Cesium3DTilesetStatistics = Cesium.Cesium3DTilesetStatistics;
const Cesium3DTileStyleEngine = Cesium.Cesium3DTileStyleEngine;
const ClippingPlaneCollection = Cesium.ClippingPlaneCollection;
const ClippingPolygonCollection = Cesium.ClippingPolygonCollection;
const hasExtension = Cesium.hasExtension;
const ImplicitTileset = Cesium.ImplicitTileset;
const ImplicitTileCoordinates = Cesium.ImplicitTileCoordinates;
const LabelCollection = Cesium.LabelCollection;
const oneTimeWarning = Cesium.oneTimeWarning;
const PointCloudEyeDomeLighting = Cesium.PointCloudEyeDomeLighting;
const PointCloudShading = Cesium.PointCloudShading;
const ResourceCache = Cesium.ResourceCache;
const SceneMode = Cesium.SceneMode;
const ShadowMode = Cesium.ShadowMode;
const SplitDirection = Cesium.SplitDirection;
const StencilConstants = Cesium.StencilConstants;
const TileBoundingRegion = Cesium.TileBoundingRegion;
const TileBoundingSphere = Cesium.TileBoundingSphere;
const TileOrientedBoundingBox = Cesium.TileOrientedBoundingBox;
const Cesium3DTilesetMostDetailedTraversal = Cesium.Cesium3DTilesetMostDetailedTraversal;
const Cesium3DTilesetBaseTraversal = Cesium.Cesium3DTilesetBaseTraversal;
const Cesium3DTilesetSkipTraversal = Cesium.Cesium3DTilesetSkipTraversal;
const Ray = Cesium.Ray;
const ImageryLayerCollection = Cesium.ImageryLayerCollection;

// BABYLON.JS: DynamicEnvironmentMapManager removed to avoid WebGL context issues
...
function Cesium3DTileset(options) {
   ...
   */
  this.foveatedInterpolationCallback = options.foveatedInterpolationCallback ?? CesiumMath.lerp;
...
function makeTile(tileset, baseResource, tileHeader, parentTile) {
  const hasImplicitTiling =
    defined(tileHeader.implicitTiling) || hasExtension(tileHeader, '3DTILES_implicit_tiling');
...
Cesium3DTileset.prototype.updateForPass = function (frameState, tilesetPassState) {
  ...
  if (
    (pass === Cesium3DTilePass.PRELOAD && (!this.preloadWhenHidden || this.show)) ||
  ...
  if (passOptions.isRender) {
    // BABYLON.JS: DynamicEnvironmentMapManager usage commented out
...
Cesium3DTileset.prototype.destroy = function () {
  ...
  // BABYLON.JS: DynamicEnvironmentMapManager destruction commented out
